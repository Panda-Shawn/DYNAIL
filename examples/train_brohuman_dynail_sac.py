...
if __name__ == "__main__":
    ...
    rollout_path = r"./expert/Humanoid-v3/rollout.pkl"
    ...
    adversarial_trainer = algo(
        ...
        eta=16.0,  # for DAIL
        # winsorize_percent=0.3, # for DAIL
        # pos_weight=40,
        mod=40,
        log_dir=log_dir,
        # use_sgd_mixup=True,
        # sgd_mixup_batch_size=40,
        allow_variable_horizon=True
    )
    print("eta: ", adversarial_trainer.eta)
